...
\def\NazwaEPSfont{\tt\tt}

%------- Kropeczki
\def\dotfill{\xleaders\hbox to 3.219pt{\hss\tiny.\hss}\hfill}
\def\Dotfill{\xleaders\hbox to 3.7pt{\hss\small.\hss}\hfill}
...
\line{\box1\hfill\lower0mm\hbox to\tmpa{\Dotfill}}}
...
\long\def\trzyokna #1 #2 #3 #4 #5 #6 #7{\noindent\hbox to #1mm{%
    \vtop{\hsize=#2mm #5}\hfil\vtop{\hsize=#3mm #6}\hfil\vtop{\hsize=#4mm #7}}}


\long\def\Trzyokna #1 #2 #3 #4 #5 #6{\noindent\hbox to 180mm{%
    \vtop{\hsize=#1mm #4}\hfill\vtop{\hsize=#2mm #5}\hfill\vtop{\hsize=#3mm #6}}}
    
\long\def\czteryokna #1 #2 #3 #4 #5 #6 #7 #8 #9{\noindent\hbox to #1mm{%
    \vtop{\hsize=#2mm #6}\hfil\vtop{\hsize=#3mm #7}\hfil\vtop{\hsize=#4mm #8}\hfil\vtop{\hsize=#5mm #9}}}    
...
\long\def\zadII#1\ezad{\vskip2pt\global\Podpunkt=97\psframebox[linecolor=red,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop{\hsize=180mm\vrule height0pt depth0mm width0pt#1}}}%
...
\long\def\zadLok#1\ezad{\vskip8pt\global\Podpunkt=97\psframebox[linecolor=yllwV,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop to 160pt{\hsize=180mm\vrule height0pt depth0mm width0pt#1\vfil}}}%
\long\def\zadLokb#1\ezad{\vskip8pt\global\Podpunkt=97\psframebox[linecolor=yllwV,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop to 336pt{\hsize=180mm\vrule height0pt depth0mm width0pt#1\vfil}}}% vtop = 160 * 2 + (12 + 8) * 1
\long\def\zadLokc#1\ezad{\vskip8pt\global\Podpunkt=97\psframebox[linecolor=yllwV,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop to 512pt{\hsize=180mm\vrule height0pt depth0mm width0pt#1\vfil}}}% vtop = 160 * 3 + (12 + 8) * 2
\long\def\zadLokz#1\ezad{\vskip8pt\global\Podpunkt=97\psframebox[linecolor=yllwV,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop to 72pt{\hsize=180mm\vrule height0pt depth0mm width0pt#1\vfil}}}% vtop = 160 * 0.5 - (12 + 8) * 0.5
\long\def\ODP#1\ezad{\vskip3mm\global\Podpunkt=97\psframebox[linecolor=blue,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop{\hsize=180mm\vrule height12pt depth0mm width0pt#1}}}%
\long\def\ODPII#1\ezad{\vskip3mm\global\Podpunkt=97\psframebox[linecolor=blue,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop{\hsize=180mm\vrule height12pt depth0mm width0pt#1}}}%

\long\def\zadLokII#1\ezad{\vskip8pt\global\Podpunkt=97\psframebox[linecolor=red,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop to 160pt{\hsize=180mm\vrule height0pt depth0mm width0pt#1\vfil}}}%
\long\def\zadLokIIb#1\ezad{\vskip8pt\global\Podpunkt=97\psframebox[linecolor=red,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop to 336pt{\hsize=180mm\vrule height0pt depth0mm width0pt#1\vfil}}}% vtop = 160 * 2 + (12 + 8) * 1
\long\def\zadLokIIc#1\ezad{\vskip8pt\global\Podpunkt=97\psframebox[linecolor=red,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop to 512pt{\hsize=180mm\vrule height0pt depth0mm width0pt#1\vfil}}}% vtop = 160 * 3 + (12 + 8) * 2
\long\def\zadLokIIz#1\ezad{\vskip8pt\global\Podpunkt=97\psframebox[linecolor=red,linewidth=.5pt,framesep=1mm]{\hskip5mm\vtop to 72pt{\hsize=180mm\vrule height0pt depth0mm width0pt#1\vfil}}}% vtop = 160 * 0.5 - (12 + 8) * 0.5
...
\def\pkolko{%
    \pscircle[linewidth=0pt,linecolor=RasterII,fillstyle=solid,fillcolor=RasterII](.35,.2){.35}\hskip7mm}


\def\szkratka{\hbox to 6mm{\psframe[linewidth=.15mm,linecolor=RasterIII,fillstyle=solid,fillcolor=RasterIII](0,-.1)(.6,.5)\hfil}}
...
\def\graframka#1{\psframebox[framearc=.4,framesep=2mm]{\vrule height11.5pt depth3.5pt width0pt\hbox to 15mm{\hss#1\hss}}}

\def\graframkaI#1{\psframebox[framearc=.4,framesep=2mm]{\vrule height11.5pt depth3.5pt width0pt\hbox to 25mm{\hss#1\hss}}}

\def\kleksI{\hskip0mm\xscale{120}\hbox{\lower4.5pt\hbox{\XeTeXpdffile '../pdf/kleks1.pdf' }}}
\def\kleksII{\hskip0mm\xscale{180}\hbox{\lower4.5pt\hbox{\XeTeXpdffile '../pdf/kleks1.pdf' }}}


\def\kratka{\lower1mm\hbox{\Frame{0pt}{.3pt}{5mm}{\vbox to 10mm{\hsize=5mm\hfil\vfil}}}}
\def\kratkagodz{\lower2mm\hbox{\Frame{0pt}{.3pt}{5mm}{\vbox to 8mm{\hsize=5mm\hfil\vfil}}}}
\def\kratKW{\lower1mm\hbox{\Frame{0pt}{.3pt}{7mm}{\vbox to 7mm{\hsize=7mm\hfil\vfil}}}}
\def\kratKWLOW{\lower2mm\hbox{\Frame{0pt}{.3pt}{7mm}{\vbox to 7mm{\hsize=7mm\hfil\vfil}}}}
\def\KI{\vskip3mm
\hskip0mm{\XeTeXpdffile '../pdf/k180-1.pdf' }}

\def\KII{\vskip3mm
\hskip0mm{\XeTeXpdffile '../pdf/k180-2.pdf' }}

\def\KIII{\vskip3mm
\hskip0mm{\XeTeXpdffile '../pdf/k180-3.pdf' }}

\def\KIV{\vskip3mm
\hskip0mm{\XeTeXpdffile '../pdf/k180-4.pdf' }}


\def\KV{\vskip3mm
\hskip0mm{\XeTeXpdffile '../pdf/k180-5.pdf' }}

\def\KIpol{\vskip3mm
\hskip0mm{\XeTeXpdffile '../pdf/k180-1-5.pdf' }}


\def\KODP{\vskip3mm
\hskip0mm{\XeTeXpdffile '../pdf/kratki-odp.pdf' }}

\def\KPOL{\vskip3mm
\hskip0mm{\XeTeXpdffile '../pdf/k90-2.pdf' }}

%\def\kratkaSz{\zscale{100}\Frame{0pt}{.3pt}{4mm}{\vbox to 6.2mm{\hsize=8mm\hfil\vfil}}}
...
\def\kratt{\lower1.2mm\hbox{\Frame{0pt}{.3pt}{10mm}{\vbox to 7mm{\hsize=10mm\hfil\vfil}}}}
...
\def\frejm{\lower1pt\hbox{\Frame{0pt}{0.3pt}{4mm}{\vbox to 15pt{\hsize=10mm\hfil\vfil}}}} %221 janowicz 15
...
%\newdimen\Pion\Pion=5mm
%\newdimen\Poziom\Poziom=5mm
%\newcount\MnoznikX
%\newcount\MnoznikY
%\def\IleKratek#1#2{%
%\global\Pion=5mm
%\global\Poziom=5mm
%\global\multiply\Pion by #2
%\global\multiply\Poziom by #1
%\MnoznikX=#1\global\advance\MnoznikX by 1
%\MnoznikY=#2\global\advance\MnoznikY by 1
%\noindent\multirput(0,-.2)(0,.5){\MnoznikY}{\psline[linewidth=.25mm,linestyle=dashed, dash=.119mm .21mm](0,0)(\Poziom,0)}%
%\multirput(0,-.2)(.5,0){\MnoznikX}{\psline[linewidth=.25mm,linestyle=dashed, dash=.119mm .21mm](0,0)(0,\Pion)}}


\def\IleKratek#1#2{%
\noindent\multirput(0,-.2)(0,.5){#2}{%
\multirput(0,0)(.5,0){#1}{\pspolygon[linewidth=.15mm, linecolor=RasterIV](0,0)(0,.5)(.5,.5)(.5,0)}}}

\def\Liniatura#1{%
\noindent\psline[linewidth=.5pt](0,.5)(#1mm,.5)%
\psline[linewidth=1pt](0,0)(#1mm,0)%
\psline[linewidth=1pt](0,-.5)(#1mm,-.5)%
\psline[linewidth=.5pt](0,-1)(#1mm,-1)
}

\def\LiniaturaB#1{%
\noindent\psline[linewidth=.5pt](0,1)(#1mm,1)%
\psline[linewidth=1pt](0,.5)(#1mm,.5)%
\psline[linewidth=1pt](0,0)(#1mm,0)%
\psline[linewidth=.5pt](0,-.5)(#1mm,-.5)
}

\def\STRZALAIII #1 {%
\psbezier[linewidth=.2mm,arrowinset=0,arrowsize=2pt 3]{->}(4.5,.3)(5,.1)(5,-.7)(4.5,-1)%
\rput[tl](5,-.2){\hbox{$#1$}}}

\def\AAA #1 {\vskip-2mm\centerline{$#1$}\vskip-2mm
\centerline{\psbezier[linewidth=.2mm,arrowinset=0,arrowsize=2pt 3]{->}(-.7,0)(-.3,.35)(.2,.35)(.7,0)}
\vskip1mm}


\def\STRZALAII #1 {\vskip-1mm\centerline{$#1$}\vskip-1mm
\centerline{\psbezier[linewidth=.2mm,arrowinset=0,arrowsize=2pt 3]{->}(-.7,0)(-.3,.4)(.2,.4)(0.7,0)}
\vskip1mm}

\def\STRZALAVI #1 {\vskip-5.5mm
\centerline{\psbezier[linewidth=.2mm,arrowinset=0,arrowsize=2pt 3]{<-}(-.7,0)(-.2,-.4)(.3,-.4)(0.7,0)}
\vskip2.5mm
\centerline{$#1$}
}

\def\STRZALAIV #1 {%
\psbezier[linewidth=.2mm,arrowinset=0,arrowsize=2pt 3]{->}(5.5,.3)(6,.1)(6,-.7)(5.5,-1)%
\rput[tl](6,-.2){\hbox{$#1$}}}

\def\STRZALAV #1 {%
\psbezier[linewidth=.2mm,arrowinset=0,arrowsize=2pt 3]{->}(3.5,.3)(4,.1)(4,-.7)(3.5,-1)%
\rput[tl](4,-.2){\hbox{#1}}}
...
\long\def\pf #1 #2 #3 #4 #5 #6                  %makro do zadań prawda/fałsz w kompozytorze dla gimnazjum. Minimum 2 zdania, maksimum 6.
     {{\nobreak\overfullrule=0pt                %wstępne skopiowane z \odp
      ...
      \SPR=\hsize\advance\SPR by -164pt\advance\SPR by -4mm         %granica to \hsize pomniejszony o pudełko prawda/fałsz i skipy
...
\long\def\tn #1 #2 #3 #4 #5 #6                  %makro do zadań tak/nie w kompozytorze dla gimnazjum. Minimum 3 zdania, maksimum 6. Różni się od \pf tylko pudełkami z prawej strony
     {{\nobreak\overfullrule=0pt                %wstępne skopiowane z \odp
      ...
      \ifnum\wd2>\SzerOka\relax\SzerOka=\wd2\relax\fi
      \SPR=\hsize\advance\SPR by -144pt\advance\SPR by -4mm         %granica to \hsize pomniejszony o pudełko tak/nie
      \ifdim\SzerOka<\SPR                       %jak się mieści to hboxy
            \vskip.4\baselineskip\hskip0pt\hbox to \SzerOka{#1\hss}\copy6
            \vskip.4\baselineskip\hskip0pt\hbox to \SzerOka{#2\hss}\copy6
            \ifnum\wd2>0\relax\vskip.4\baselineskip\hskip0pt\hbox to \SzerOka{#3\hss}\copy6\relax\fi %nie wypisuj zerowych 3456
...
\long\def\pfII #1 #2 #3 #4 #5 #6 #7             %makro do zadań prawda/fałsz w kompozytorze dla gimnazjum. Minimum 2 zdania, maksimum 6.
     {{\nobreak\overfullrule=0pt                %wstępne skopiowane z \odp
      ...
      \ifnum\wd0>\wd1\relax\SzerOka=\wd0\relax
            \else\SzerOka=\wd1\relax\fi %spr największego pudełka z trójki 123
      \ifnum\wd2>\SzerOka\relax\SzerOka=\wd2\relax\fi
      \SPR=\hsize\advance\SPR by -4mm\advance\SPR by -#1pt         %granica to \hsize pomniejszony o pudełko prawda/fałsz i skipy
      \ifdim\SzerOka<\SPR                       %jak się mieści to hboxy
            \vskip.4\baselineskip\hskip0pt\hbox to \SzerOka{#2\hss}\copy6
...
\long\def\tnII #1 #2 #3 #4 #5 #6 #7             %makro do zadań tak/nie w kompozytorze dla gimnazjum. Minimum 3 zdania, maksimum 6. Różni się od \pf tylko pudełkami z prawej strony
     {{\nobreak\overfullrule=0pt                %wstępne skopiowane z \odp
      ...
      \ifnum\wd0>\wd1\relax\SzerOka=\wd0\relax\else\SzerOka=\wd1\relax\fi %spr największego pudełka z trójki 123
      \ifnum\wd2>\SzerOka\relax\SzerOka=\wd2\relax\fi
      \SPR=\hsize\advance\advance\SPR by -4mm\SPR by -#1pt         %granica to \hsize pomniejszony o pudełko tak/nie
      \ifdim\SzerOka<\SPR                       %jak się mieści to hboxy
            \vskip.4\baselineskip\hskip0pt\hbox to \SzerOka{#2\hss}\copy6
            \vskip.4\baselineskip\hskip0pt\hbox to \SzerOka{#3\hss}\copy6
            \ifnum\wd2>0\relax\vskip.4\baselineskip\hskip0pt\hbox to \SzerOka{#4\hss}\copy6\relax\fi %nie wypisuj zerowych 3456
...
%------- \naklejka
%---------------------------
\newcmykcolor{RasterII}{0 0 0 .2}
\newcmykcolor{RasterIII}{0 0 0 .1}
\newcmykcolor{Raster}{0 0 0 .3}
\newcmykcolor{RasterIV}{0 0 0 .4}
%-------------------------------------Shadow--------------------------------------
